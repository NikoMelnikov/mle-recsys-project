...
logger.info('Recommendation service is being initialized.')

TOP_POPULAR_RECS_PATH = os.getenv("TOP_POPULAR_RECS_PATH")
PERSONAL_RECS_PATH = os.getenv("PERSONAL_RECS_PATH")
features_store_url = os.getenv("FUTURE_PORT")
events_store_url = os.getenv("EVENT_PORT") 
...
class Recommendations:
    ...
    def load(self, type, path, **kwargs):
        ...
        logger.info(f"Loaded, type: {type}")
